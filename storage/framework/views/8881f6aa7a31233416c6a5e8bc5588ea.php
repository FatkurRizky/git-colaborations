    ...
    <div class="mx-auto max-w-7xl">
        <div class="mb-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            ...
            <div class="flex flex-wrap gap-2">
                <a href="<?php echo e(route('rekon-kas.edit', $rekonKas)); ?>"
        ...
        <div class="mb-6 grid grid-cols-1 gap-4 lg:grid-cols-3">
            <div class="rounded-2xl bg-white p-5 shadow-sm ring-1 ring-slate-200">
                ...
                <p class="mt-2 text-2xl font-bold text-slate-900">
                    <?php echo e($rekonKas->rekon_date?->format('d-m-Y')); ?>
            ...
            <div class="rounded-2xl bg-white p-5 shadow-sm ring-1 ring-slate-200">
                ...
                <div class="mt-3">
                    <span class="inline-flex rounded-full px-3 py-1 text-sm font-semibold ring-1 <?php echo e($statusClass); ?>">
                        <?php echo e(ucfirst($rekonKas->status)); ?>
            ...
            <div class="rounded-2xl bg-white p-5 shadow-sm ring-1 ring-slate-200">
                ...
                <p class="mt-2 text-2xl font-bold text-slate-900">
                    <?php echo e($rekonKas->creator->name ?? '-'); ?>
                ...
                <div class="divide-y divide-slate-100">
                    <div class="flex items-center justify-between px-6 py-4">
                        ...
                        <span class="text-base font-semibold text-slate-900">
                            Rp <?php echo e(number_format($rekonKas->opening_cash, 0, ',', '.')); ?>
                    ...
                    <div class="flex items-center justify-between px-6 py-4">
                        ...
                        <span class="text-base font-semibold text-slate-900">
                            Rp <?php echo e(number_format($rekonKas->cash_income, 0, ',', '.')); ?>
                    ...
                    <div class="flex items-center justify-between px-6 py-4">
                        ...
                        <span class="text-base font-semibold text-slate-900">
                            Rp <?php echo e(number_format($rekonKas->non_cash_income, 0, ',', '.')); ?>
                    ...
                    <div class="flex items-center justify-between px-6 py-4">
                        ...
                        <span class="text-base font-semibold text-slate-900">
                            Rp <?php echo e(number_format($rekonKas->operational_cash, 0, ',', '.')); ?>
            ...
            <div class="rounded-2xl bg-white shadow-sm ring-1 ring-slate-200">
                ...
                <div class="divide-y divide-slate-100">
                    <div class="flex items-center justify-between px-6 py-4">
                        ...
                        <span class="text-base font-semibold text-slate-900">
                            Rp <?php echo e(number_format($rekonKas->cash_expected, 0, ',', '.')); ?>
                    ...
                    <div class="flex items-center justify-between px-6 py-4">
                        ...
                        <span class="text-base font-semibold text-slate-900">
                            Rp <?php echo e(number_format($rekonKas->actual_cash, 0, ',', '.')); ?>
                    ...
                    <div class="flex items-center justify-between px-6 py-4">
                        ...
                        <span class="text-base font-bold <?php echo e($differenceClass); ?>">
                            Rp <?php echo e(number_format($rekonKas->difference, 0, ',', '.')); ?>
        ...
        <div class="mt-6 rounded-2xl bg-white shadow-sm ring-1 ring-slate-200">
            <div class="border-b border-slate-200 px-6 py-4 flex items-center justify-between">
                ...
                <?php if($rekonKas->proof_of_expense): ?>
                    <a href="<?php echo e(asset('storage/' . $rekonKas->proof_of_expense)); ?>" target="_blank" 
            ...
            <div class="px-6 py-4">
                <p class="text-sm leading-6 text-slate-700">
                    <?php echo e($rekonKas->notes ?: 'Tidak ada catatan.'); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/muhammad/Kalkulator_rekon/resources/views/rekon-kas/show.blade.php ENDPATH**/ ?>