            ...
            <div class="w-full max-w-md relative">
                <div class="rounded-3xl bg-white p-8 shadow-xl ring-1 ring-slate-200 sm:p-10">
                    ...
                    <p class="text-center mt-8 text-sm text-gray-500">
                        Belum Punya Akun? 
                        <a href="<?php echo e(route('register')); ?>" class="text-emerald-600 font-bold hover:underline">Daftar Gratis</a>
                    </p>
                </div>
            </div>
        </div>
...
</script><?php /**PATH /home/muhammad/Kalkulator_rekon/resources/views/auth/login.blade.php ENDPATH**/ ?>