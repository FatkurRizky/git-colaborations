                ...
                <div class="rounded-[2.5rem] bg-white p-8 shadow-[0_20px_60px_-15px_rgba(0,0,0,0.05)] ring-1 ring-slate-200 sm:p-10 transition-all duration-300 hover:shadow-2xl">
                    ...
                    <?php if($errors->any()): ?>
                        <div class="mb-6 rounded-2xl border border-red-200 bg-red-50 p-4 animate-pulse">
                            <div class="flex gap-3">
                                ...
                                <p class="text-sm text-red-700 font-semibold"><?php echo e($errors->first()); ?></p>
                            </div>
                        </div>
                    <?php endif; ?>
                    ...
                    <form method="POST" action="<?php echo e(route('register')); ?>" class="space-y-5">
                        ...
                        <p class="text-center text-sm text-slate-500 mt-8 italic-none">
                            Sudah punya akun? <a href="<?php echo e(route('login')); ?>" class="font-black text-emerald-600 hover:text-emerald-700 transition-colors">LOGIN DISINI</a>
                        </p>
                    </form>
                </div>
            </div>
...
</script><?php /**PATH /home/muhammad/Kalkulator_rekon/resources/views/auth/register.blade.php ENDPATH**/ ?>