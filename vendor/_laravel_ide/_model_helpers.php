...
namespace App\Models {
     ...
     * @property integer $actual_cash
     * @property integer $cash_expected
     * @property integer $operational_cash
     * @property integer $non_cash_income
     * @property integer $cash_income
     * @property integer $opening_cash
     * @property \Illuminate\Support\Carbon $rekon_date
     * @property int $id
     * @property-read \App\Models\User $creator
     * @method static \Illuminate\Database\Eloquent\Builder<RekonKas>|RekonKas whereId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<RekonKas>|RekonKas whereRekonDate($value)
     * @method static \Illuminate\Database\Eloquent\Builder<RekonKas>|RekonKas whereOpeningCash($value)
     * @method static \Illuminate\Database\Eloquent\Builder<RekonKas>|RekonKas whereCashIncome($value)
     * @method static \Illuminate\Database\Eloquent\Builder<RekonKas>|RekonKas whereNonCashIncome($value)
     * @method static \Illuminate\Database\Eloquent\Builder<RekonKas>|RekonKas whereOperationalCash($value)
     * @method static \Illuminate\Database\Eloquent\Builder<RekonKas>|RekonKas whereCashExpected($value)
     * @method static \Illuminate\Database\Eloquent\Builder<RekonKas>|RekonKas whereActualCash($value)
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<RekonKas>|RekonKas newModelQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<RekonKas>|RekonKas newQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<RekonKas>|RekonKas query()
     ...
     */
    class RekonKas extends \Illuminate\Database\Eloquent\Model
    {
        //
    }
     ...
     * @property int $id
     * @property-read \Illuminate\Database\Eloquent\Collection<int, \App\Models\RekonKas> $rekonRecords
     * @property-read int|null $rekon_records_count
